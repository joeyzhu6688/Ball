...
function setup(){
    ...
    greenBox = Bodies.rectangle(450,320,110,120,greenBox_options);
    ...
    yellowBox2 = Bodies.rectangle(100,320,100,20,yellowBox2_options);
    // Matter.Body.setAngle(yellowBox2,130)
    World.add(myworld,yellowBox2);
    ...
    ball = Bodies.circle(620,0,20, ball_options);
...
function draw(){
    ...
    fill("yellow")
    push();
    translate(yellowBox2.position.x,yellowBox2.position.y);
    rotate(45);
    rectMode(CENTER);
    rect(0, 0, 100, 20);
    pop();
